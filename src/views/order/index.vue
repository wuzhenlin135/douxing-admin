<template>
  <div class="app-container calendar-list-container">
    ...
    <div class="filter-container">
      <el-select clearable style="width: 140px" class="filter-item" v-model="listQuery.scenicId" placeholder="选择景区">
        <el-option v-for="item in scenicesOptions" :key="item.key" :label="item.label" :value="item.key">
        </el-option>
      </el-select>
      <el-select clearable style="width: 140px" class="filter-item" v-model="listQuery.communId" placeholder="选择客栈">
        <el-option v-for="item in communsOptions" :key="item.key" :label="item.label" :value="item.key">
        </el-option>
      </el-select>
...
<script>
import { getList, getFitlers } from '@/api/order'
  ...
  methods: {
    ...
    fetchFitlers() {
      ...
      getFitlers().then(response => {
        this.scenicesOptions = response.obj.scenicesOptions
        this.communsOptions = response.obj.communsOptions
